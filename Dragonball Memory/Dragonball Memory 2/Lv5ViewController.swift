...
class Lv5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //curLevel = 5
        resetGame()
        initGame(numberOfCards: 36, lblCards:lblCollectionCards,lblTap:lblTap)
        arrButtons = [btn0,btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btn10,btn11,btn12,btn13,btn14,btn15,btn16,btn17,btn18,btn19,btn20,btn21,btn22,btn23,btn24,btn25,btn26,btn27,btn28,btn29,btn30,btn31,btn32,btn33,btn34,btn35]
        limitTime = 90
        countDown = limitTime
    ...
    @IBAction func btnATapone(_ sender: UIButton) {
        ...
        indexTag = sender.tag
        tap()
        Timer.scheduledTimer(timeInterval: 1.5, target: self, selector: #selector(Lv5ViewController.finishGame), userInfo: nil, repeats: false)
        Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(Lv5ViewController.updateValue), userInfo: nil, repeats: false)
    }
    ...
    @IBAction func btnANext(_ sender: UIButton) {
        let nextScr = storyboard?.instantiateViewController(withIdentifier: "Lv6ViewController")
