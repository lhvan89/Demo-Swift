...
class ChapterPageViewController: UIPageViewController {
    ...
    func setFirstPage() {
        let beforeVC = self.storyboard?.instantiateViewController(withIdentifier: "chapterVC") as! ChapterViewController
        beforeVC.index = 0
    ...
    func createNewChapterView(currentVC: UIViewController, isNextPage: Bool) -> UIViewController? {
        ...
        let newVC = self.storyboard?.instantiateViewController(withIdentifier: "chapterVC") as! ChapterViewController
